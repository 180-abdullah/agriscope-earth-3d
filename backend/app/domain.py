...
def risk_level(score: float) -> RiskLevel:
    """
    Agricultural screening interpretation scale.

    Scores represent priority for verification,
    not probability of crop loss or disaster.
    """
...
def heat_index_c(
    ...
    Used only as a screening indicator.
    """
